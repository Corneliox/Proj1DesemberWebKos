...
<style>
    ...
    .starter-page-page {
        padding: 0; /* Remove padding for full video effect */
    }
    ...
    .comment-form {
        max-width: 400px;
        margin: 100px auto; /* Center and add margin to the top */
    ...
    /* Optional: Style for better visibility of text */
    .comment-form h4, .comment-form p {
        text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.7); /* Adds shadow for better contrast */
    }
</style>
        ...
        <section id="comment-form" class="comment-form section">
            <div class="container">
                ...
                <form action="proseslogin.php" method="post">
                    ...
                    <h4>Login</h4>
                   <p class="mt-3 mb-0" style="color: black;">Silahkan masuk</p>
                    <div class="row">
