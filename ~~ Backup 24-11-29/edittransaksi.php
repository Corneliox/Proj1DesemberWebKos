<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "UPDATE transaksi SET userName = ?, status = ? WHERE referenceId = ?";
		$stmt = $conn->prepare($sql);
...
<head>
  ...
  <title>Edit Transaksi - <?= $application_name; ?></title>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Edit Transaksi</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
		  ...
		  <form action=""  method="post">
			...
			<div class="row">
			  <div class="col form-group">
				<input id="userName" name="userName" type="text" class="form-control" placeholder="Nama" value="<?= $data['userName']; ?>" required>
			  </div>
			</div>
			<div class="row">
			  <div class="col form-group">
				<input id="status" name="status" type="text" class="form-control" placeholder="Status" value="<?= $data['status']; ?>" required>
			  </div>
			</div>
