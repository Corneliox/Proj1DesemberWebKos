...
<head>
  ...
  <title>Pelanggan - <?= $application_name; ?></title>
        ...
        <table id="myTable" class="table table-bordered table-striped" style="width: 100%;">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class="btn btn-success" href="./editpelanggan.php?id=<?= $data['id']; ?>"><i class='fa fa-edit'></i> Edit</a>
						<a class="btn btn-danger" href="./hapuspelanggan.php?id=<?= $data['id']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?')"><i class='fa fa-trash'></i> Hapus</a>
					</td>
				</tr>
				<?php
					}
