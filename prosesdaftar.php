...
$no_hp = isset($_POST['phone']) ? $_POST['phone'] : '';
...
$stmt->bind_param("ssss", $nama, $email, $no_hp, $password_hashed);
...
<div class="container register-result-container">
    <?php if ($success): ?>
        ...
        <a href="login.php" class="btn btn-custom btn-block mt-3">Login Sekarang</a>
    <?php else: ?>
        ...
        <?php endif; ?>
        <a href="daftar.php" class="btn btn-custom btn-block mt-3">Kembali ke Form Daftar</a>
    <?php endif; ?>
</div>
